...
namespace StreamDeckDockerPlugin
{
  [ActionUuid(Uuid= "com.magnuspihl.plugin.action.DockerToggle")]
  public class DockerToggleAction : BaseStreamDeckActionWithSettingsModel<Models.CounterSettingsModel>
  {
